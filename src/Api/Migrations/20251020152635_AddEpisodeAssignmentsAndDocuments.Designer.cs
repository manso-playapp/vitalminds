...
namespace VitalMinds.Clinic.Api.Migrations
{
    ...
    [Migration("20251020152635_AddEpisodeAssignmentsAndDocuments")]
    partial class AddEpisodeAssignmentsAndDocuments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VitalMinds.Clinic.Api.Domain.Entities.DocumentSignature", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("EpisodeDocumentId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("FirmadoEl")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("FirmadoPorProfessionalId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EpisodeDocumentId");

                    b.HasIndex("FirmadoPorProfessionalId");

                    b.HasIndex("FirmadoPorUserId");
            ...
            modelBuilder.Entity("VitalMinds.Clinic.Api.Domain.Entities.EpisodeAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("EpisodeAssignments");
                });

            modelBuilder.Entity("VitalMinds.Clinic.Api.Domain.Entities.EpisodeDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("SubidoPorProfessionalId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SubidoPorProfessionalId");
            ...
            modelBuilder.Entity("VitalMinds.Clinic.Api.Domain.Entities.InstitutionProfessional", b =>
                {
                    b.Property<Guid>("InstitutionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("InstitutionId", "ProfessionalId");

                    b.HasIndex("ProfessionalId");

                    b.ToTable("InstitutionProfessionals");
                });
            ...
            modelBuilder.Entity("VitalMinds.Clinic.Api.Domain.Entities.Professional", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ApplicationUser", b =>
                {
                    ...
                    b.HasOne("VitalMinds.Clinic.Api.Domain.Entities.Professional", "Professional")
                        .WithOne("User")
                        .HasForeignKey("ApplicationUser", "ProfessionalId")
            ...
            modelBuilder.Entity("VitalMinds.Clinic.Api.Domain.Entities.DocumentSignature", b =>
                {
                    b.HasOne("VitalMinds.Clinic.Api.Domain.Entities.EpisodeDocument", "EpisodeDocument")
                        .WithMany("Firmas")
                        .HasForeignKey("EpisodeDocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VitalMinds.Clinic.Api.Domain.Entities.Professional", "FirmadoPorProfessional")
                        .WithMany()
                        .HasForeignKey("FirmadoPorProfessionalId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ApplicationUser", "FirmadoPorUser")
                        .WithMany()
                        .HasForeignKey("FirmadoPorUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("EpisodeDocument");

                    b.Navigation("FirmadoPorProfessional");

                    b.Navigation("FirmadoPorUser");
                });
            ...
            modelBuilder.Entity("VitalMinds.Clinic.Api.Domain.Entities.Episode", b =>
                {
                    ...
                    b.HasOne("VitalMinds.Clinic.Api.Domain.Entities.Professional", "Professional")
                        .WithMany("EpisodiosResponsables")
            ...
            modelBuilder.Entity("VitalMinds.Clinic.Api.Domain.Entities.EpisodeAssignment", b =>
                {
                    b.HasOne("VitalMinds.Clinic.Api.Domain.Entities.Professional", "AssignedByProfessional")
                        .WithMany("AsignacionesDerivadas")
            ...
            modelBuilder.Entity("VitalMinds.Clinic.Api.Domain.Entities.EpisodeDocument", b =>
                {
                    ...
                    b.HasOne("VitalMinds.Clinic.Api.Domain.Entities.Professional", "SubidoPorProfessional")
                        .WithMany()
                        .HasForeignKey("SubidoPorProfessionalId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ApplicationUser", "SubidoPorUser")
                        .WithMany()
                    ...
                    b.Navigation("SubidoPorProfessional");

                    b.Navigation("SubidoPorUser");
                });
            ...
            modelBuilder.Entity("VitalMinds.Clinic.Api.Domain.Entities.Professional", b =>
                {
                    b.Navigation("AsignacionesDerivadas");

                    b.Navigation("AsignacionesRecibidas");

                    b.Navigation("EpisodiosResponsables");
